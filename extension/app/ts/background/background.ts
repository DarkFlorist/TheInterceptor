import { InterceptedRequest, PopupMessage, SignerName } from '../utils/interceptor-messages'
import 'webextension-polyfill'
import { Simulator } from '../simulation/simulator'
import { EIP2612Message, EthereumAddress, EthereumQuantity, EthereumUnsignedTransaction } from '../utils/wire-types'
import { getSettings, saveActiveChain, saveActiveSigningAddress, saveActiveSimulationAddress, Settings } from './settings'
import { blockNumber, call, chainId, estimateGas, gasPrice, getAccounts, getBalance, getBlockByNumber, getCode, getPermissions, getTransactionByHash, getTransactionReceipt, personalSign, requestPermissions, sendRawTransaction, sendTransaction, signTypedDataV4, subscribe, switchEthereumChain, unsubscribe } from './simulationModeHanders'
import { changeActiveAddress, changeAddressInfos, changeMakeMeRich, changePage, resetSimulation, confirmDialog, RefreshSimulation, removeTransaction, requestAccountsFromSigner, refreshPopupConfirmTransactionSimulation, confirmPersonalSign, confirmRequestAccess, changeInterceptorAccess, changeChainDialog, popupChangeActiveChain, enableSimulationMode, reviewNotification, rejectNotification } from './popupMessageHandlers'
import { AddressMetadata, SimResults, SimulationState, TokenPriceEstimate } from '../utils/visualizer-types'
import { WebsiteApproval, SignerState } from '../utils/user-interface-types'
import { getAddressMetadataForAccess, setPendingAccessRequests } from './windows/interceptorAccess'
import { CHAINS, ICON_NOT_ACTIVE, isSupportedChain, MAKE_YOU_RICH_TRANSACTION, METAMASK_ERROR_USER_REJECTED_REQUEST } from '../utils/constants'
import { PriceEstimator } from '../simulation/priceEstimator'
import { getActiveAddressForDomain, sendActiveAccountChangeToApprovedWebsitePorts, sendMessageToApprovedWebsitePorts, updateWebsiteApprovalAccesses, verifyAccess } from './accessManagement'
import { getAddressMetadataForVisualiser } from './metadataUtils'
import { getActiveAddress, sendPopupMessageToOpenWindows } from './backgroundUtils'
import { updateExtensionIcon } from './iconHandler'
import { connectedToSigner, ethAccountsReply, signerChainChanged, walletSwitchEthereumChainReply } from './providerMessageHandlers'
