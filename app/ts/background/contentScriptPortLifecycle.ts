...
export function tryRegisterContentScriptPortListeners(port: browser.runtime.Port, onDisconnect: () => void, onMessage: (payload: unknown) => void, checkRuntimeLastError: () => void) {
	try {
