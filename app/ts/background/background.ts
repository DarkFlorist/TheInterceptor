	...
	try {
		const processRequest = async (): Promise<PopupReplyOption | void> => {
			switch (parsedRequest.method) {
				...
				case 'popup_requestInterceptorSimulateInput': return await requestEthSimulateV1Input(simulator.ethereum)
