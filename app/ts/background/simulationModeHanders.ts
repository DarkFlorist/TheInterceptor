...
import {
	createEthereumSubscription,
	createNewFilter,
	getEthFilterChanges,
	getEthFilterLogs,
	removeEthereumSubscription,
} from '../simulation/services/EthereumSubscriptionService.js'
import {
	getSimulatedBalanceFromInput,
	getSimulatedBlockByHashFromInput,
	getSimulatedBlockFromInput,
	getSimulatedBlockNumberFromInput,
	getSimulatedCodeFromInput,
	getSimulatedLogs,
	getSimulatedTransactionByHashFromInput,
	getSimulatedTransactionReceipt,
	simulatedCallFromInput,
	simulateEstimateGasFromInput,
	getInputFieldFromDataOrInput,
	getSimulatedFeeHistory,
	getSimulatedTransactionCountFromInput,
} from '../simulation/services/SimulationModeEthereumClientService.js'
import {
	DEFAULT_CALL_ADDRESS,
	ERROR_INTERCEPTOR_GET_CODE_FAILED,
...
import {
	openConfirmTransactionDialogForMessage,
	openConfirmTransactionDialogForTransaction,
...
export async function getBlockByHash(
	...
	request: EthBlockByHashParams,
) {
	return {
		type: 'result' as const,
		method: request.method,
		result: await getSimulatedBlockByHashFromInput(
...
export async function getBlockByNumber(
	ethereumClientService: EthereumClientService,
	simulationInput: ResolvedSimulationInput,
	request: EthBlockByNumberParams,
) {
	return {
		type: 'result' as const,
		method: request.method,
		result: await getSimulatedBlockFromInput(
			ethereumClientService,
			undefined,
			simulationInput,
			request.params[0],
...
export async function getBalance(
	ethereumClientService: EthereumClientService,
	simulationInput: ResolvedSimulationInput,
	request: EthBalanceParams,
) {
	return {
		type: 'result' as const,
		method: request.method,
		result: await getSimulatedBalanceFromInput(
			ethereumClientService,
			undefined,
			simulationInput,
			request.params[0],
...
export async function getTransactionByHash(
	ethereumClientService: EthereumClientService,
	simulationInput: ResolvedSimulationInput,
	request: TransactionByHashParams,
) {
	const result = await getSimulatedTransactionByHashFromInput(
		ethereumClientService,
		undefined,
		simulationInput,
		request.params[0],
	...
	if (result === null)
		return { type: 'result' as const, method: request.method, result: null }
	return { type: 'result' as const, method: request.method, result: result }
}
export async function getTransactionReceipt(
	ethereumClientService: EthereumClientService,
	simulationState: ResolvedExecutionSimulationState,
	request: TransactionReceiptParams,
) {
	return {
		type: 'result' as const,
		method: request.method,
		result: await getSimulatedTransactionReceipt(
			ethereumClientService,
			undefined,
			simulationState,
			request.params[0],
...
export async function sendTransaction(
	...
	const action = await openConfirmTransactionDialogForTransaction(
		ethereumClientService,
		tokenPriceService,
		request,
		transactionParams,
...
async function singleCallWithFromOverride(
	ethereumClientService: EthereumClientService,
	simulationInput: ResolvedSimulationInput,
	...
	const blockTag =
		request.params.length > 1 ? request.params[1] : ('latest' as const)
	...
	return await simulatedCallFromInput(
		ethereumClientService,
		undefined,
		simulationInput,
		callTransaction,
...
export async function call(
	...
	const callParams = request.params[0]
	const from =
		callParams.from !== undefined ? callParams.from : DEFAULT_CALL_ADDRESS
	const callResult = await singleCallWithFromOverride(
		ethereumClientService,
		simulationInput,
		request,
		from,
...
export async function blockNumber(
	...
	return {
		...
		result: await getSimulatedBlockNumberFromInput(
			ethereumClientService,
			undefined,
			simulationInput,
		),
...
export async function estimateGas(
	...
	const estimatedGas = await simulateEstimateGasFromInput(
		ethereumClientService,
		undefined,
		simulationInput,
		request.params[0],
	...
	if ('error' in estimatedGas)
		return { type: 'result' as const, method: request.method, ...estimatedGas }
	return {
		type: 'result' as const,
		method: request.method,
...
export async function subscribe(
	...
	request: EthSubscribeParams,
) {
	return {
		type: 'result' as const,
		method: request.method,
		result: await createEthereumSubscription(request, socket),
	}
}

export async function unsubscribe(
	socket: WebsiteSocket,
	request: EthUnSubscribeParams,
) {
	return {
		type: 'result' as const,
		method: request.method,
		result: await removeEthereumSubscription(socket, request.params[0]),
	}
}
...
export async function chainId(ethereumClientService: EthereumClientService) {
	return {
		...
		result: ethereumClientService.getChainId(),
	}
}
...
export async function netVersion(ethereumClientService: EthereumClientService) {
	return {
		...
		result: (await chainId(ethereumClientService)).result,
	}
}
...
export async function gasPrice(ethereumClientService: EthereumClientService) {
	return {
		...
		result: await ethereumClientService.getGasPrice(undefined),
	}
}
...
export async function personalSign(
	...
	const action = await openConfirmTransactionDialogForMessage(
		ethereumClientService,
		tokenPriceService,
		request,
		transactionParams,
...
export async function switchEthereumChain(
	...
	const change = await openChangeChainDialog(
		ethereumClientService,
		tokenPriceService,
...
export async function getCode(
	...
	const code = await getSimulatedCodeFromInput(
		ethereumClientService,
		undefined,
		simulationInput,
		request.params[0],
...
export async function getTransactionCount(
	...
	return {
		type: 'result' as const,
		method: request.method,
		result: await getSimulatedTransactionCountFromInput(
			ethereumClientService,
			undefined,
			simulationInput,
			request.params[0],
...
export async function web3ClientVersion(
	...
	return {
		...
		result: await ethereumClientService.web3ClientVersion(undefined),
	}
}
...
export async function feeHistory(
	...
	return {
		...
		result: await getSimulatedFeeHistory(
			ethereumClientService,
			undefined,
			request,
		),
...
export async function installNewFilter(
	socket: WebsiteSocket,
...
export async function uninstallNewFilter(
	socket: WebsiteSocket,
	request: UninstallFilter,
) {
	return {
		type: 'result' as const,
		method: request.method,
...
export async function getFilterChanges(
	request: GetFilterChanges,
	ethereumClientService: EthereumClientService,
	simulationState: ResolvedExecutionSimulationState,
) {
	const result = await getEthFilterChanges(
		request.params[0],
		ethereumClientService,
		undefined,
		simulationState,
	...
	if (result === undefined)
		return {
			...
			error: {
				...
				message: 'No filter found for identifier',
			},
		}
...
export async function getFilterLogs(
	request: GetFilterLogs,
	ethereumClientService: EthereumClientService,
	simulationState: ResolvedExecutionSimulationState,
) {
	const result = await getEthFilterLogs(
		request.params[0],
		ethereumClientService,
		undefined,
		simulationState,
...
export async function requestInterceptorSimulatorStack(
	...
	const result = await openFetchSimulationStackDialogOrGetCachedResult(
		simulationState,
		websiteTabConnections,
		params,
		website,
