...
export async function getBlockByHash(ethereumClientService: EthereumClientService, simulationInput: ResolvedSimulationInput, request: EthBlockByHashParams) {
	return {
		...
		result: await getSimulatedBlockByHashFromInput(ethereumClientService, undefined, simulationInput, request.params[0], request.params[1]),
	}
}
export async function getBlockByNumber(ethereumClientService: EthereumClientService, simulationInput: ResolvedSimulationInput, request: EthBlockByNumberParams) {
	return {
		type: 'result' as const,
		method: request.method,
		result: await getSimulatedBlockFromInput(ethereumClientService, undefined, simulationInput, request.params[0], request.params[1]),
	}
}
export async function getBalance(ethereumClientService: EthereumClientService, simulationInput: ResolvedSimulationInput, request: EthBalanceParams) {
	return {
		type: 'result' as const,
		method: request.method,
		result: await getSimulatedBalanceFromInput(ethereumClientService, undefined, simulationInput, request.params[0], request.params[1]),
	}
}
...
export async function getTransactionReceipt(ethereumClientService: EthereumClientService, simulationState: ResolvedExecutionSimulationState, request: TransactionReceiptParams) {
	return {
		type: 'result' as const,
		method: request.method,
		result: await getSimulatedTransactionReceipt(ethereumClientService, undefined, simulationState, request.params[0]),
	}
}
...
export async function blockNumber(ethereumClientService: EthereumClientService, simulationInput: ResolvedSimulationInput) {
	return {
		...
		result: await getSimulatedBlockNumberFromInput(ethereumClientService, undefined, simulationInput),
	}
}
...
export async function personalSign(ethereumClientService: EthereumClientService, tokenPriceService: TokenPriceService, activeAddress: bigint | undefined, transactionParams: SignMessageParams, request: InterceptedRequest, website: Website, websiteTabConnections: WebsiteTabConnections, simulationMode = true) {
...
export async function getTransactionCount(ethereumClientService: EthereumClientService, simulationInput: ResolvedSimulationInput, request: GetTransactionCount) {
	return {
		type: 'result' as const,
		method: request.method,
		result: await getSimulatedTransactionCountFromInput(ethereumClientService, undefined, simulationInput, request.params[0], request.params[1]),
	}
}
...
export async function getLogs(ethereumClientService: EthereumClientService, simulationState: ResolvedExecutionSimulationState, request: EthGetLogsParams) {
	return {
		type: 'result' as const,
		method: request.method,
		result: await getSimulatedLogs(ethereumClientService, undefined, simulationState, request.params[0]),
	}
}
...
export async function feeHistory(ethereumClientService: EthereumClientService, request: FeeHistory) {
	return {
		...
		result: await getSimulatedFeeHistory(ethereumClientService, undefined, request),
	}
}
...
export async function installNewFilter(socket: WebsiteSocket, request: EthNewFilter, ethereumClientService: EthereumClientService, simulationInput: ResolvedSimulationInput) {
	return {
		type: 'result' as const,
		method: request.method,
		result: await createNewFilter(request, socket, ethereumClientService, undefined, simulationInput),
	}
}
