...
export const websiteAccessPopupMessageHandlers = {
	popup_interceptorAccess: popupMessageHandler('popup_interceptorAccess', async (context, request) => await confirmRequestAccess(context.ethereum, context.tokenPriceService, context.simulationServicesOwner, context.websiteTabConnections, request, context.publishRpcConnectionStatus)),
	popup_changeInterceptorAccess: popupMessageHandler('popup_changeInterceptorAccess', async (context, request) => await changeInterceptorAccess(context.ethereum, context.tokenPriceService, context.simulationServicesOwner, context.websiteTabConnections, request)),
	...
	popup_setDisableInterceptor: popupMessageHandler('popup_setDisableInterceptor', async (context, request) => await disableInterceptor(context.ethereum, context.tokenPriceService, context.simulationServicesOwner, context.websiteTabConnections, request)),
	...
	popup_blockOrAllowExternalRequests: popupMessageHandler('popup_blockOrAllowExternalRequests', async (context, request) => await blockOrAllowExternalRequests(context.ethereum, context.tokenPriceService, context.simulationServicesOwner, context.websiteTabConnections, request)),
	...
	popup_removeWebsiteAccess: popupMessageHandler('popup_removeWebsiteAccess', async (context, request) => await removeWebsiteAccess(context.ethereum, context.tokenPriceService, context.simulationServicesOwner, context.websiteTabConnections, request)),
	popup_removeWebsiteAddressAccess: popupMessageHandler('popup_removeWebsiteAddressAccess', async (context, request) => await removeWebsiteAddressAccess(context.ethereum, context.tokenPriceService, context.simulationServicesOwner, context.websiteTabConnections, request)),
