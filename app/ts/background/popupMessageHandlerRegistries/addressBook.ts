...
export const addressBookPopupMessageHandlers = {
	popup_addOrModifyAddressBookEntry: popupMessageHandler('popup_addOrModifyAddressBookEntry', async (context, request) => await addOrModifyAddressBookEntry(context.ethereum, context.tokenPriceService, context.simulationServicesOwner, context.websiteTabConnections, request)),
	...
	popup_removeAddressBookEntry: popupMessageHandler('popup_removeAddressBookEntry', async (context, request) => await removeAddressBookEntry(context.ethereum, context.tokenPriceService, context.simulationServicesOwner, context.websiteTabConnections, request)),
