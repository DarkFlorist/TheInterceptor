...
export const settingsPopupMessageHandlers = {
	...
	popup_restoreDefaultRpcConfiguration: popupMessageHandler('popup_restoreDefaultRpcConfiguration', async (context) => await restoreDefaultRpcConfiguration(context.simulationServicesOwner)),
