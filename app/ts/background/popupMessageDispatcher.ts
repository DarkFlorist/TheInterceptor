...
const popupMessageHandlers = {
	...
	popup_changeChainDialog: popupMessageHandler('popup_changeChainDialog', async (context, request) => await changeChainDialog(context.ethereum, context.tokenPriceService, context.simulationServicesOwner, context.websiteTabConnections, request)),
	...
	popup_setSafeSimulationSigner: popupMessageHandler('popup_setSafeSimulationSigner', async (context, request) => await setSafeSimulationSigner(context.ethereum, context.tokenPriceService, context.simulationServicesOwner, context.websiteTabConnections, request)),
