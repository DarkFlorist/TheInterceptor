...
import { addOrModifyAddressBookEntry, allowOrPreventAddressAccessForWebsite, blockOrAllowExternalRequests, changeActiveAddress, changeAddOrModifyAddressWindowState, changeChainDialog, changeInterceptorAccess, changePage, changePreSimulationBlockTimeManipulation, changeSettings, confirmDialog, confirmRequestAccess, disableInterceptor, enableSimulationMode, exportSettings, fetchSimulationStackRequestConfirmation, forceSetGasLimitForTransaction, getAddressBookData, importSafeStack, importSettings, importSimulationStack, interceptorAccessChangeAddressOrRefresh, modifyMakeMeRich, modifyRichToken, openNewTab, openWebPage, popupChangeActiveRpc, popupReadyAndListening, refreshHomeData, refreshPopupConfirmTransactionMetadata, refreshPopupConfirmTransactionSimulation, removeAddressBookEntry, removeTransactionOrSignedMessage, removeWebsiteAccess, removeWebsiteAddressAccess, reportUnexpectedErrorInWindow, requestAbiAndNameFromBlockExplorer, requestAccountsFromSigner, requestActiveAddresses, requestCompleteVisualizedSimulation, requestHomePageBootstrap, requestIdentifyAddress, requestInterceptorSimulationInput, requestLatestUnexpectedError, requestMakeMeRichList, requestNewHomeData, requestSafeStackExport, requestSimulationMetadata, requestSimulationMode, retrieveWebsiteAccess, setActiveSafeSigner, setEnsNameForHash, setNewRpcList, setTransactionOrMessageBlockTimeManipulator, settingsOpened, simulateGnosisSafeTransactionOnPass, simulateGovernanceContractExecutionOnPass, watchAssetDialog } from './popupMessageHandlers.js'
...
const popupMessageHandlers = {
	...
	popup_modifyRichToken: popupMessageHandler('popup_modifyRichToken', async (context, request) => await modifyRichToken(context.ethereum, context.simulationAbortController, request)),
	...
	popup_requestSafeStackExport: popupMessageHandler('popup_requestSafeStackExport', async (context) => await requestSafeStackExport(context.ethereum, context.tokenPriceService)),
