...
export async function extractEIP712Message(ethereumClientService: EthereumClientService, message: EIP712Message, useLocalStorage = true): Promise<EnrichedEIP712> {
	return {
