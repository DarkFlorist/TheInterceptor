...
export const ENS_ADDR_REVERSE_NODE = {
	name: 'addr.reverse',
	nameHash: BigInt(namehash('addr.reverse')),
}
...
export const HTTP_STATUS_SERVER_ERROR_RANGE_START = 500
export const JSON_RPC_ERROR_CODE_INTERNAL_ERROR = -32603
...
export const ERROR_INTERCEPTOR_DISABLED = {
	error: {
		code: METAMASK_ERROR_USER_REJECTED_REQUEST,
		message: 'The Interceptor is disabled',
	},
}
export const METAMASK_ERROR_ALREADY_PENDING = {
	error: { code: -32002, message: 'Access request pending already.' },
}
export const ERROR_INTERCEPTOR_NO_ACTIVE_ADDRESS = {
	error: { code: 2, message: 'Interceptor: No active address' },
}
export const METAMASK_ERROR_NOT_CONNECTED_TO_CHAIN = {
	error: { code: 4900, message: 'Interceptor: Not connected to chain' },
}
export const ERROR_INTERCEPTOR_GET_CODE_FAILED = {
	error: { code: -40001, message: 'Interceptor: Get code failed' },
} // I wonder how we should come up with these numbers?
