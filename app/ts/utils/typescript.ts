...
> = T extends unknown ? Pick<T, Exclude<keyof T, K>> : never
...
export function getWithDefault<Key, Value>(
	map: Map<Key, Value>,
	key: Key,
	defaultValue: Value,
) {
...
export function modifyObject<T extends object>(
	original: T,
	subObject: NoInfer<Split<T>>,
): T {
