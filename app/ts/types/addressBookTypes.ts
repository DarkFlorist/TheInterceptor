...
export const ChainIdWithUniversal = funtypes.Union(
	EthereumQuantity,
	funtypes.Literal('AllChains'),
)
...
export type DeclarativeNetRequestBlockMode = funtypes.Static<
	typeof DeclarativeNetRequestBlockMode
>
export const DeclarativeNetRequestBlockMode = funtypes.Union(
...
export const ContactEntry = funtypes
	.ReadonlyObject({
		...
		name: funtypes.String,
		address: EthereumAddress,
		entrySource: funtypes.Union(
			EntrySource,
			funtypes
				.Literal(undefined)
				.withParser(LiteralConverterParserFactory(undefined, 'User' as const)),
		),
	})
	.And(
		funtypes.Partial({
...
export type AddressBookEntryCategory =
	| 'contact'
	| 'activeAddress'
	| 'ERC20'
	| 'ERC721'
...
export const AddressBookEntryType = funtypes.Union(
	funtypes.Literal('contact'),
	funtypes.Literal('contract'),
	funtypes.Literal('ERC20'),
	funtypes.Literal('ERC1155'),
	funtypes.Literal('ERC721'),
)

export type IncompleteAddressBookEntry = funtypes.Static<
	typeof IncompleteAddressBookEntry
>
