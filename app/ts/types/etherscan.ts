...
export type EtherscanSourceCodeResult = funtypes.Static<
	typeof EtherscanSourceCodeResult
>
export const EtherscanSourceCodeResult = funtypes
	.Object({
		...
		result: funtypes.ReadonlyTuple(
			funtypes.Object({
				...
				ABI: funtypes.String,
				Proxy: funtypes.Union(
					funtypes
						.Literal('1')
						.withParser(LiteralConverterParserFactory('1', 'yes' as const)),
					funtypes
						.Literal('0')
						.withParser(LiteralConverterParserFactory('0', 'no' as const)),
				),
...
export type EtherscanGetABIResult = funtypes.Static<
	typeof EtherscanGetABIResult
>
export const EtherscanGetABIResult = funtypes
	.Object({
		status: funtypes.Union(
			funtypes
				.Literal('1')
...
export type SourcifyMetadataResult = funtypes.Static<
	typeof SourcifyMetadataResult
>
export const SourcifyMetadataResult = funtypes
	.Object({
