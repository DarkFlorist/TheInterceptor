...
export const Page = funtypes.Union(
	...
	funtypes.ReadonlyObject({
		page: funtypes.Literal('AddNewAddress'),
		state: ModifyAddressWindowState,
	}),
	funtypes.ReadonlyObject({
		page: funtypes.Literal('ModifyAddress'),
		state: ModifyAddressWindowState,
	}),
	...
	funtypes.ReadonlyObject({
		page: funtypes.Literal('EditEnsNamedHash'),
		state: EditEnsNamedHashWindowState,
	}),
)

export type ActiveAddress = funtypes.Static<typeof ActiveAddress>
export const ActiveAddress = funtypes
	.ReadonlyObject({
