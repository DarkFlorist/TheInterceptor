...
export const EIP712Types = funtypes.Record(funtypes.String, funtypes.ReadonlyArray(funtypes.ReadonlyObject({ name: funtypes.String, type: funtypes.String })))
...
export const EnrichedEIP712MessageRecord: funtypes.Runtype<TypeEnrichedEIP712MessageRecord> = funtypes.Lazy(() =>
	funtypes.Union(
		EnrichedGroupedSolidityType,
		funtypes.ReadonlyObject({
			type: funtypes.Literal('record'),
			value: funtypes.ReadonlyRecord(funtypes.String, EnrichedEIP712MessageRecord),
		}),
		funtypes.ReadonlyObject({
			type: funtypes.Literal('record[]'),
			value: funtypes.ReadonlyArray(funtypes.ReadonlyRecord(funtypes.String, EnrichedEIP712MessageRecord)),
		}),
	),
)

export type EnrichedEIP712Message = funtypes.Static<typeof EnrichedEIP712Message>
export const EnrichedEIP712Message = funtypes.ReadonlyRecord(funtypes.String, EnrichedEIP712MessageRecord)
