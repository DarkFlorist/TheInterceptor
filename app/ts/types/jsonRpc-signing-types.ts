...
export type OldSignTypedDataParams = funtypes.Static<
	typeof OldSignTypedDataParams
>
...
export const PersonalSignParams = funtypes.ReadonlyObject({
	...
	params: funtypes.Union(
		funtypes.ReadonlyTuple(
			funtypes.String,
			EthereumAddress,
			funtypes.Union(funtypes.String, funtypes.Undefined, funtypes.Null),
...
export const SignMessageParams = funtypes.Union(
	PersonalSignParams,
	SignTypedDataParams,
