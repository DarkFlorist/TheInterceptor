...
>['config'] = {
	parse: (value) => {
		...
		return {
			success: true,
			value: BigInt(value.startsWith('-') ? -value.slice(1) : value),
		}
	},
	serialize: (value) => {
...
export const PureGroupedSolidityType = funtypes.Union(
	...
	funtypes.ReadonlyObject({
		type: funtypes.Literal('unsignedInteger'),
	...
	funtypes.ReadonlyObject({
		type: funtypes.Literal('fixedBytes'),
		value: EthereumData,
	}),
	funtypes.ReadonlyObject({
		type: funtypes.Literal('bool'),
		value: funtypes.Boolean,
	}),
	funtypes.ReadonlyObject({
	...
	funtypes.ReadonlyObject({
		type: funtypes.Literal('signedInteger[]'),
		value: funtypes.ReadonlyArray(SignedBigInt),
	}),
	funtypes.ReadonlyObject({
		type: funtypes.Literal('unsignedInteger[]'),
		value: funtypes.ReadonlyArray(EthereumQuantity),
	}),
	funtypes.ReadonlyObject({
		type: funtypes.Literal('bytes[]'),
		value: funtypes.ReadonlyArray(EthereumData),
	}),
	funtypes.ReadonlyObject({
		type: funtypes.Literal('fixedBytes[]'),
		value: funtypes.ReadonlyArray(EthereumData),
	...
	funtypes.ReadonlyObject({
		type: funtypes.Literal('bool[]'),
		value: funtypes.ReadonlyArray(funtypes.Boolean),
	}),
	funtypes.ReadonlyObject({
		type: funtypes.Literal('string[]'),
		value: funtypes.ReadonlyArray(funtypes.String),
	}),
	funtypes.ReadonlyObject({
		type: funtypes.Literal('address[]'),
		value: funtypes.ReadonlyArray(EthereumAddress),
	}),
)
...
export const EnrichedGroupedSolidityType = funtypes.Union(
	...
	funtypes.ReadonlyObject({
		type: funtypes.Literal('address[]'),
		value: funtypes.ReadonlyArray(AddressBookEntry),
	}),
)
