		...
		<>
			...
			<div class="modal-card">
				...
				<footer class="modal-card-foot window-footer" style="border-bottom-left-radius: unset; border-bottom-right-radius: unset; border-top: unset; padding: 10px;">
					...
					<button class="button is-warning is-danger" onClick={param.close}>
						Cancel
					</button>
				</footer>
			</div>
...
export function AddressBook() {
	const addressBookEntriesWithFilter = useSignal<AddressBookEntriesWithFilter>({
		addressBookEntries: [],
	...
	const viewFilter = useSignal<ViewFilter>({
		activeFilter: 'My Active Addresses',
		searchString: '',
		chain: undefined,
	})
						...
						viewFilter.value = {
							...
							chain:
								activeChain.value === undefined
									? undefined
									: {
											name: activeChain.value.name,
											chainId: activeChain.value.chainId,
										},
						}
					}
				}
	...
	function changeActiveChain(entry: ChainEntry) {
		...
		viewFilter.value = {
			...viewFilter.peek(),
			chain: { name: entry.name, chainId: entry.chainId },
		}
	}
			...
			<Hint>
				<div class="columns" style={{ width: 'fit-content', margin: 'auto', padding: '0 1rem' }}>
					<div style={{ padding: '1rem 0' }}>
						...
						<aside class="menu">
							<ul class="menu-list">
								<p class="paragraph" style="color: var(--disabled-text-color)">
									{' '}
									My Addresses{' '}
								</p>
								<ul>
