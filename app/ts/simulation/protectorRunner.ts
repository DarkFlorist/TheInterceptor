...
import type { WebsiteCreatedEthereumUnsignedTransaction, SimulationState } from '../types/visualizer-types.js'
...
const PROTECTORS = [selfTokenOops, commonTokenOops, feeOops, eoaApproval, eoaCalldata, tokenToContract, sendToNonContact, chainIdMismatch]
