...
function SigningWalletPage() {
	...
	return <main class = 'signing-page'>
		...
		{ kind === 'airgap' ? <section class = 'signing-panel'>
			...
			{ scan ? <SigningQrScanner onFrame = { importPublicAccountFrame } onError = { () => setStatus('Account scan stopped.') } onStart = { () => { accountImporter.current = createAirGapAccountImporter() } }/> : undefined }
