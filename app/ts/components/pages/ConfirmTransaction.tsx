			...
			>
				...
				<div class="card-content" style="padding-bottom: 5px;">
					...
					<RawTransactionDetailsCard
						...
						renameAddressCallBack={param.renameAddressCallBack}
						gasSpent={'gasSpent' in simTx ? simTx.gasSpent : undefined}
						addressMetaData={addressMetaData}
					/>
...
const CheckBoxes = (params: CheckBoxesParams) => {
	...
	if (currentResults.transactionStatus !== 'Transaction Succeeded')
		return (
			<div style="display: grid">
				<div style={margins}>
					<ErrorCheckBox
	...
	if (currentResults.quarantine === true)
		return (
			<div style="display: grid">
				<div style={margins}>
					<ErrorCheckBox
...
export function ConfirmTransaction() {
	...
	const refreshMetadata = async () => {
		...
		await sendPopupMessageToBackgroundPage({
			method: 'popup_refreshConfirmTransactionMetadata',
		})
	}
