	...
	return (
		<div class="media">
			<div class="media-left" style="margin-right: 0.2rem;">
				<img
					style="transform: scaleX(-1); justify-content: center; display: flex;"
					src="../img/LOGOA.svg"
					width="24"
					height="24"
				/>
			...
			<div
				class="media-content"
				style="overflow-y: hidden; overflow-x: clip; display: block; margin: auto;"
			>
...
export function DinoSaysNotification({
	text,
	close,
}: {
	text: string
	...
	return (
		<div style="display: flex; align-items: center; justify-content: center;">
			<div
				class="notification notification-importance-box"
