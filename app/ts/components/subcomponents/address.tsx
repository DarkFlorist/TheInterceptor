...
export function SmallAddress({ addressBookEntry, renameAddressCallBack, noEditAddress, style }: SmallAddressParams) {
	...
	return <InlineCard label = { currentAddressBookEntry.name } copyValue = { addressString } icon = { generateIcon } onEditClicked = { noEditAddress ? undefined : () => renameAddressCallBack(currentAddressBookEntry) } style = { style } />
}
