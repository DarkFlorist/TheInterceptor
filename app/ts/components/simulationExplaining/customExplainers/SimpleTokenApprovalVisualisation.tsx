...
export function SimpleTokenApprovalVisualisation(
	param: SimpleTokenApprovalVisualisation,
) {
					...
					<div class="log-cell" style="justify-content: right;">
						{param.approval.type === 'NFT All approval' ? (
							...
							<>
								...
								param.approval.amount >= 2n ** 96n - 1n ? (
									<p
										class="ellipsis"
										style={`color: ${textColor}; font-size: 28px; font-weight: 500`}
									>
										<b>ALL</b>
									</p>
								) : 'amount' in param.approval ? (
