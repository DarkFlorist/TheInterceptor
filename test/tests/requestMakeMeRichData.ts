...
export async function main() {
	describe('requestMakeMeRichList resilience', () => {
		should('falls back per address and preserves the underlying error message', async () => {
		...
		should('recovers from corrupt fixed rich list storage by resetting it to an empty list', async () => {
			const storageState = installBrowserMock()
