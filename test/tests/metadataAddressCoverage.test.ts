...
const ZERO_BLOCK_TIME_MANIPULATION = {
	...
	deltaToAdd: 0n,
	deltaUnit: 'Seconds',
} satisfies SimulationStateInput[number]['blockTimeManipulation']
const toAddressArg = (paramName: string, value: bigint): SolidityVariable => ({
	paramName,
	typeValue: { type: 'address', value },
})
const simulationWebsite = {
	websiteOrigin: 'https://example.com',
	icon: undefined,
	title: 'Example',
}
const simulationCreated = new Date('2024-01-01T00:00:00.000Z')
const simulationOriginalRequestParameters: SendTransactionParams = {
	...
	const inputData: readonly EnrichedEthereumInputData[] = [
		{
			...
			args: [
				{
					paramName: 'recipient',
					typeValue: { type: 'address', value: INPUT_ADDRESS },
				},
			],
		},
	]
