...
const POPUP_MARK_NAMES = ['interceptor:popup:script-start', 'interceptor:popup:shell-painted', 'interceptor:popup:home-first-commit'] as const
...
const WORKER_MARK_NAMES = ['interceptor:background:refresh-home-start', 'interceptor:background:refresh-home-end'] as const
